...
- Scans ONLY the condensed novel text (immutable input)
...
# --------------------------------------------------
# 
# This dictionary defines event-related keywords for detection.
# It is MANUALLY CURATED and VERSIONED for reproducibility.
#
# Format:
#   keyword_id: {
#       "terms": [list of terms/phrases to match],
